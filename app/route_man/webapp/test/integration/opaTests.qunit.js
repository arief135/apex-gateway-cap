...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "id/apnv/apex/ui/routeman/test/integration/FirstJourney",
    "id/apnv/apex/ui/routeman/test/integration/RoutesListJourney",
    "id/apnv/apex/ui/routeman/test/integration/RoutesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
